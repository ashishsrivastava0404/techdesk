    ...
    <div className="auth-page">
      <div className="auth-container">
        <div className="auth-header">
          ...
          <p>Join our platform and start earning</p>
        </div>
            ...
            <div className="role-selection">
              <label className={`role-option ${role === 'customer' ? 'selected' : ''}`}>
                ...
                <div className="role-content">
                  ...
                  <span className="role-desc">Submit tickets and get help</span>
                </div>
              </label>
              <label className={`role-option ${role === 'tech' ? 'selected' : ''}`}>
                <input
                  type="radio"
                  name="role"
                  value="tech"
                ...
                <div className="role-content">
                  ...
                  <span className="role-desc">Earn by solving tickets</span>
                </div>
              </label>
            </div>
          </div>
